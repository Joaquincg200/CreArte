...
function AddProduct() {
  ...
  let image = null;
  if (imageFile) {
    image = await toBase64(imageFile); // convierte a Base64
  }
  ...
  const payload = {
    ...
    price: productPrice,
    stock: productQuantity,  // asegúrate que coincida con tu DTO
        ...
        <div className="container py-5">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row g-4">
              {/* IZQUIERDA - FORMULARIO (con p-4 rounded shadow h-100) */}
              <div className="col-6">
                <div
