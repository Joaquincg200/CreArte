...
function ProfileSeller() {
  ...
  // Fetch usuario por ID y actualizar cookie
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        // Actualizamos cookie y estado global
  ...
  // Redirección segura para compradores
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (imageFile) {
      avatarToSend = await toBase64(imageFile);
    }
  ...
  if (!user) return null; // Esperar a cargar datos
